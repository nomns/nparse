...
class MapData(dict):
    ...
    def _load(self):
        ...
        left, right = (
            int(math.floor(lowest_x / 1000) * 1000),
            int(math.ceil(highest_x / 1000) * 1000),
        )
        top, bottom = (
            int(math.floor(lowest_y / 1000) * 1000),
            int(math.ceil(highest_y / 1000) * 1000),
        )
        ...
        self.grid.setPen(QPen(line.color, profile.maps.grid_line_width))
        ...
        for line in self.raw["lines"]:
            ...
            if not temp_dict[lz]["paths"].get(lc, None):
                ...
                path_item.setPen(QPen(line.color, profile.maps.line_width))
